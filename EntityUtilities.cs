// Thanks to UgurhanK @ Github for the ThirdPerson work
// https://github.com/UgurhanK/ThirdPerson-WIP
...
public static class EntityUtilities
{
    ...
    {
        if (!player1.Validity() || !player2.Validity()) return false;
    ...
    public static bool Validity(this CCSPlayerController player)
    {
        if (
              player == null
